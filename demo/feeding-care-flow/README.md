...
7. 控制页顶部帮助与设置、`Switch`、四种标准模式、1–15 档、灯光开关与 `Glow / Soft / Clear` 均可交互，并同步显示当前选中状态；所有主控、吸乳中、最佳档位和自定义分段页面均不再展示 Frequency。
...
12. 吸乳中页面长按 `Hold to finish` 1.2 秒结束本次吸乳，保存记录后进入数据页；吸乳中仍可调整模式、1–15 档和灯光。
